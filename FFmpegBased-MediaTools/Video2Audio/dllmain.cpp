...
MTL_dllinfo __stdcall GetInfo() {
    ...
    wcscpy_s(info.szAppName, DoesUserUsesChinese() ?
		L"将视频文件转换为音频" : L"Convert video to audio");
...
"b534fabd76fe449bac3916f0e2881305.app/mtl-app/cls/Video2Audio-AppFrame";
...
#include "../MediaToolsLoader/ctls.h"
	...
	case WM_USER + 0xf0:
	{
		...
		SendMessage(data->hCombo1, CB_ADDSTRING, 0, (LPARAM)L"mp3");
		SendMessage(data->hCombo1, CB_ADDSTRING, 0, (LPARAM)L"wav");
